...
public:
	...
	typedef typename ht::const_pointer cosnt_pointer;
...
public:
	...
	template<class InputIterator>
	hash_set(InputIterator f, InputIterator l, size_type n,
		const hasher& hf, const key_equal& eql):rep(n, hf, eql){rep.insert_unique(f,l);}
...
public:
	...
	//const iterator begin() const {return rep.begin();}
	iterator end() const {return rep.end();}
	//const iterator end() const {return rep.end();}
...
inline bool operator==(const hash_set<Value, HashFcn, EqualKey, Alloc>& hsl,
